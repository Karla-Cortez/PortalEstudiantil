...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "PortalEstudiantil", Version = "v1" });
...
builder.Services.AddSingleton<IJwtAuthenticationServices>(new JwtAuthenticationServices(key));
#endregion
